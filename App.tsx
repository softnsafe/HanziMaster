            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full px-5 py-3 rounded-2xl bg-slate-50 border-2 border-slate-200 focus:border-fuchsia-400 focus:ring-4 focus:ring-fuchsia-100 outline-none transition-all font-bold text-slate-700 placeholder-slate-300 pr-12"
                  />
                  <button
                    type="button"
